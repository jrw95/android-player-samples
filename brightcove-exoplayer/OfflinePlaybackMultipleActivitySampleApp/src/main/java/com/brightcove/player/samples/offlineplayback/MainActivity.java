...
public class MainActivity extends Activity {
     ...
     */
    static final String ACCOUNT_ID = "5420904993001";

    /**
     * The policy key for the video cloud account.
     */
    static final String POLICY_KEY = "BCpkADawqM1RJu5c_I13hBUAi4c8QNWO5QN2yrd_OgDjTCVsbILeGDxbYy6xhZESTFi68MiSUHzMbQbuLV3q-gvZkJFpym1qYbEwogOqKCXK622KNLPF92tX8AY9a1cVVYCgxSPN12pPAuIM";
        ...
        if (connectivityMonitor.isConnected()) {
            ...
            playlist.findPlaylist(catalog, httpRequestConfig, new PlaylistListener() {
                ...
                public void onError(@NonNull String error) {
                    String message = showToast("Failed to find videoModel[%s]: %s", playlist.displayName, error);
                    Log.w(TAG, message);
    ...
    private final VideoListListener videoListListener = new VideoListListener() {
        ...
        @Override
        public void loadPlayer(@NonNull Video video) { MainActivity.this.loadPlayer(video); }
...
//                    httpRequestConfigBuilder.setBrightcoveAuthorizationToken(pasToken);
    ...
    private void loadPlayer(@NonNull Video video) {
        Intent playerIntent = new Intent(MainActivity.this, PlayerActivity.class);
        playerIntent.putExtra("videoId", video.getId());
