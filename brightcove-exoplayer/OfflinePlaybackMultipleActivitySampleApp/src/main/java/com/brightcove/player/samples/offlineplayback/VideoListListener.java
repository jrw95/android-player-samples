...
public interface VideoListListener {
     ...
     * video thumbnail. The handler is expected to set the video ID into the Intent so that it
     * can be passed to the PlayerActivity.
     *
     * @param video reference to the video.
     */
    void loadPlayer(@NonNull Video video);
