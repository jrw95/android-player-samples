...
public class MainActivity extends BrightcovePlayer {
    ...
    private BrightcoveDrmSession brightcoveDrmSession;
    ...
    private void onCreate() {
        ...
        eventEmitter.on(EventType.DID_SET_SOURCE, event -> {
            ...
            Source source = (Source) event.getProperties().get(Event.SOURCE);

//            licenseManager = OfflinePlaybackPlugin.getInstance().createLicenseManager(video, source);
//            if (licenseManager != null) {
//                licenseManager.setPropertyString("securityLevel", "L3");
